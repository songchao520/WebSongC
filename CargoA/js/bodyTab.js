...
layui.define(['layer',"element","jquery"],function(exports){
	...
	//显示左侧菜单
	if($(".navBar").html() == ''){
		var huobang_loginuser = JSON.parse(sessionStorage.getItem("huobang_loginuser"));
		$.post(huobang_url+"/getPagesByUser",{loginId:huobang_loginId,usertyperecid:huobang_loginuser["utyperecid"]},function(data){
