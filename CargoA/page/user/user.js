	...
	var layer = parent.layer === undefined ? layui.layer : parent.layer;
        ...
        form.verify({
            oldPwd : function(value, item){
                ...
                if(value != loginuser["loginpassword"]){
                    return "密码错误，请重新输入！";
                }
            },
        ...
        form.on("submit(changePwd)",function(data){
        	var index = layer.msg('提交中，请稍候',{icon: 16,time:false,shade:0.8});
        	var loginpassword = $("#newPwd").val();
        	var recid=loginuser["recid"];
        	$.post(huobang_url+"/updateUser",{loginId:huobang_loginId,recid:recid,loginpassword:loginpassword},function(data){
        		if(data!="wdl"){
        			if(data == "success"){
        				layer.close(index);
		                layer.msg("密码修改成功！");
